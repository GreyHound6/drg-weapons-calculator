...
public abstract class Classic extends Weapon {
	...
	****************************************************************************************/
	...
	protected void initializeModsAndOverclocks() {
		...
		overclocks[1] = new Overclock(Overclock.classification.clean, "Minimal Clips", "+6 Clip Size, -0.2 Reload Time", overclockIcons.magSize, 1);
		...
		overclocks[3] = new Overclock(Overclock.classification.balanced, "Hipster", "+3 Rate of Fire, x1.25 Max Ammo, -16% Spread per Shot, x0.85 Max Bloom, x0.5 Recoil, -9 Direct Damage", overclockIcons.baseSpread, 3);
