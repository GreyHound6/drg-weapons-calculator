...
public class Shotgun extends Weapon {
	...
	****************************************************************************************/
	...
	protected void initializeModsAndOverclocks() {
		...
		tier2 = new Mod[3];
		tier2[0] = new Mod("Expanded Ammo Bags", "+35 Max Ammo", modIcons.carriedAmmo, 2, 0);
		...
		tier3[1] = new Mod("Quickfire Ejector", "-0.7 Reload Time", modIcons.reloadSpeed, 3, 1);
		...
		tier5 = new Mod[2];
		tier5[0] = new Mod("Turret Whip", "Shoot a Turret with the Shotgun to consume 8 turret ammo and fire a projectile in the direction currently being aimed at by the turret, "
				+ "with a 3 second cooldown between projectiles. Each projectile travels at 50 m/sec, does 160 Explosive element Area Damage in a 1.5m radius, has a 100% chance to stun "
