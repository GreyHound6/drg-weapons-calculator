...
public class Flamethrower extends Weapon {
	...
	****************************************************************************************/
	...
	protected void initializeModsAndOverclocks() {
		...
		tier5 = new Mod[2];
		tier5[0] = new Mod("Heat Radiance", "After every full second of firing, deal 55 Fire element Area Damage and 55 Heat in a 3m radius around you. The Heat/sec stacks with the direct stream and Sticky Flames' heat sources as well.", modIcons.heatDamage, 5, 0);
		...
		overclocks[2] = new Overclock(Overclock.classification.balanced, "Compact Feed Valves", "+50 Fuel Tank Size, -2m Flame Reach", overclockIcons.magSize, 2);
		...
		overclocks[4] = new Overclock(Overclock.classification.unstable, "Face Melter", "+6 Damage per Particle, +1.8 Flow Rate, -75 Max Fuel, x0.5 Movement Speed while using", overclockIcons.directDamage, 4);
	...
	****************************************************************************************/
	...
	private double calculateDPS(boolean burst, boolean primaryTarget) {
		...
		if (selectedTier5 == 0) {
			...
			heatRadianceDmgAndHeatPerTick = 55.0 * 3.0 / getFlameReach();
	...
	public double calculateMaxMultiTargetDamage() {
		...
		if (selectedTier5 == 0) {
			...
			heatRadianceTotalDamage = 55 * numTicksOfHeatRadiance * numGlyphidsHitByHeatRadiancePerTick;
		}
