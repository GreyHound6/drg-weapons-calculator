	...
	****************************************************************************************/
	...
	protected void initializeModsAndOverclocks() {
		...
		overclocks[4] = new Overclock(Overclock.classification.unstable, "Turret Arc", "If a bullet fired from the SMG hits a turret and applies an Electrocute DoT, that turret deals constant Electric Damage in a small radius around it for 15 seconds. "
				+ "Additionally, if 2 turrets are less than 10m apart and both have the Electric Charge the same time, then an electric arc will pass between them for the remainder of the EC duration that slows enemies by 70% and does 35 Electric Damage per Second until the first turret's electrocute expires. "
