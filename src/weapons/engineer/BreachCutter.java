...
public class BreachCutter extends Weapon {
	...
	****************************************************************************************/
	...
	protected void initializeModsAndOverclocks() {
		...
		tier5 = new Mod[3];
		tier5[0] = new Mod("Explosive Goodbye", "After firing a line and a 0.4 second delay, the player can press the fire button again to manually detonate the line dealing 90 Explosive element Area Damage in a 2.5m radius "
		...
		overclocks[6] = new Overclock(Overclock.classification.unstable, "Inferno", "The first time the beam hits an enemy, it inflicts 75 Heat and applies a DoT that does 7 Fire Damage and 7 Heat at a rate of 2 ticks/sec for 5 seconds (does 11 ticks total). "
				+ "Additionally, it converts 90% of the Damage per Tick from Electric element to Fire element and adds the amount converted as Heat per tick. This also adds +1.5 Damage per Tick (75 DPS).  In exchange: -3 Max Ammo, and x0.5 Armor Breaking", overclockIcons.heatDamage, 6);
